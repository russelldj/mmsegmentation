...
def rui_yamaha_classes():
    """Merged Rui and Yamaha datasets with consistent class names for external use"""
    return [
        "sky",
        "traversable ground",
...
def rui_yamaha_palette():
    """Merged Rui and Yamaha datasets with consistent class names for external use"""
    # "sky", "traversable ground", "traversable vegetation", "untraversable vegetation", "obstacle", "trunk"
    return [
        [0, 0, 255],
        [128, 128, 128],
        [150, 75, 0],
